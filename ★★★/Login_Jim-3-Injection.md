...
3. **Payload utilisé**  
   J’ai saisi le payload suivant dans le champ email :  jim@kuice-sh.op'--
...
Après soumission, l’authentification a été bypassée et j’ai été connecté en tant que Jim.
...
- Mettre en place une protection contre les injections (ORM, validation stricte)  
